...
function EditemploymentModal({ closeEditEmploymentModal, refresherEmploymentData, editId, mobileNum }) {
    ...
    const updateForm = () => {
        ...
        set(ref(db, `interviewcandidates/${mobileNum}/employmentdata/${editId}`), {
            currentlyEmployed,
            companyName,
            designation,
            joining_date,
    ...
    useEffect(() => {
        setIsLoadingoverlayEffect(true)
        const starCountRef = ref(db, `interviewcandidates/${mobileNum}/employmentdata/${editId}`);
